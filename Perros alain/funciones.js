        ...
        switch (t) {
            case 1: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-success' role='alert'>Se agrego con exito el perro</div>"
                );
                break;
            case 2: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-danger' role='alert'>Se elimino el Perro</div>"
                );
                break;
            default:
...
if (dbVacas.length !== 0) {
    ...
    $("#dbVacas-list").append("<h2> No tienes Perros </h2>");
}
